...
public class FlowerBouquetTest {
    ...
    public void testFlowerBouquet() {
        ...
        decoratedRoseBouquet = new Glitter(new RibbonBow(new PaperWrapper(decoratedRoseBouquet)));
        ...
        */
        ...
        decoratedOrchidBouquet = new RibbonBow(new PaperWrapper(new PaperWrapper(decoratedOrchidBouquet)));
