...
import guru.springframework.gof.state.states.CandyVendingMachineState;
import guru.springframework.gof.state.states.ContainsCoinState;
import guru.springframework.gof.state.states.DispensedState;
import guru.springframework.gof.state.states.NoCandyState;
import guru.springframework.gof.state.states.NoCoinState;
